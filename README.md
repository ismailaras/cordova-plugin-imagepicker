...
using the Cordova / Phonegap command line interface.
    ...
    # without desc
    phonegap plugin add https://github.com/lancer/cordova-plugin-imagepicker.git
    cordova plugin add https://github.com/lancer/cordova-plugin-imagepicker.git
    
    # with desc
    phonegap plugin add https://github.com/lancer/cordova-plugin-imagepicker.git --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="your usage message"

    cordova plugin add https://github.com/lancer/cordova-plugin-imagepicker.git --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="your usage message"
